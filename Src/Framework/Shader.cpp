...
namespace Desperado
{
	...
	Shader::SharedPtr Shader::create(const char* vertexPath, const char* fragmentPath,
	...
	Shader::Shader(const char* vertexPath, const char* fragmentPath,
	               const char* geometryPath) : mCurrTexUnit(0)
	{
	...
	void Shader::setTexture2D(const std::string& name, const Texture::SharedPtr pTex)
	{
		//GLint maxUnitCnt = 0;
